...
/** 
TODO (refactor - just initialize it) 
TODO - escolher realmente se queremos um header solido ou não etc etc
    Codigo já esta preparado para isso
*/
...
body.dark {
    ...
    --headerBackgroundSolid: ${V.Color.lightBlack};
...
@keyframes moveSecondHeroUpLeft {
    ...
    80% {
        transform: translateX(-8rem, -2rem);
    }
...
@keyframes moveThirdHeroUpLeft {
    ...
    80% {
        transform: translateX(-12rem, -4rem);
    }
